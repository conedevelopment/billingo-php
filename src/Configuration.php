...
class Configuration
{
     ...
     * @var string
     */
    protected string $host = 'https://api.billingo.hu/v3';
    ...
    {
        $report  = 'PHP SDK (Cone\Billingo) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 3.0.14' . PHP_EOL;
