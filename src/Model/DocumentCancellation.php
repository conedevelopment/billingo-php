...
class DocumentCancellation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'DocumentCancellation';
    ...
    protected static array $attributeMap = [
        ...
        'cancellationRecipients' => 'cancellation_recipients',
    ];
    ...
    /**
     * Gets cancellationRecipients
     *
     * @return string|null
     */
    public function getCancellationRecipients(): ?string
    {
        return $this->container['cancellationRecipients'];
    }
     ...
     * @return $this
     */
    public function setCancellationRecipients(?string $cancellationRecipients): static
    {
        if (is_null($cancellationRecipients)) {
            throw new InvalidArgumentException('non-nullable cancellationRecipients cannot be null');
        }
        $this->container['cancellationRecipients'] = $cancellationRecipients;
