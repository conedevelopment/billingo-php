...
class ModificationDocumentInsert implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'ModificationDocumentInsert';
     ...
     * Gets items
     *
     * @return (\Cone\Billingo\Model\DocumentItemData|\Cone\Billingo\Model\DocumentProductData)[]|null
     */
     ...
     * Sets items
     *
     * @param (\Cone\Billingo\Model\DocumentItemData|\Cone\Billingo\Model\DocumentProductData)[]|null $items items
     *
     * @return $this
     */
