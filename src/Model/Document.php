...
class Document implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('recurringId', $data ?? [], null);
    }
     ...
     * Sets paidDate
     *
     * @param \DateTime|null $paidDate If payment_status equals 'paid' or 'partially_paid', it will show the paid date otherwise the current date.
     *
     * @return self
     */
    ...
    {
        return $this->container['recurringId'];
    }

    /**
     * Sets recurringId
     *
     * @param int|null $recurringId recurringId
     *
     * @return self
     */
    public function setRecurringId($recurringId)
    {
        if (is_null($recurringId)) {
            throw new \InvalidArgumentException('non-nullable recurringId cannot be null');
        }
        $this->container['recurringId'] = $recurringId;
