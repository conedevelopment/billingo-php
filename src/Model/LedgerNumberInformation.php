...
class LedgerNumberInformation implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'LedgerNumberInformation';
     ...
     * @return string|null
     */
    public function getBevetel(): ?string
    {
     ...
     * @return $this
     */
    public function setBevetel(?string $bevetel): static
    {
        if (is_null($bevetel)) {
     ...
     * @return string|null
     */
    public function getVevo(): ?string
    {
     ...
     * @return $this
     */
    public function setVevo(?string $vevo): static
    {
        if (is_null($vevo)) {
     ...
     * @return string|null
     */
    public function getPenztar(): ?string
    {
     ...
     * @return $this
     */
    public function setPenztar(?string $penztar): static
    {
        if (is_null($penztar)) {
     ...
     * @return $this
     */
    public function setAfa(?string $afa): static
    {
        if (is_null($afa)) {
