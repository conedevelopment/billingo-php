...
class SpendingApi
{
     ...
     * @param  DateType|null $spendingDate spendingDate (optional)
     * @param  string|null $startDate startDate (optional)
     * @param  string|null $endDate endDate (optional)
     * @param  PaymentStatusSpending|null $paymentStatus paymentStatus (optional)
     * @param  Source|null $spendingType spendingType (optional)
     * @param  Category|null $categories categories (optional)
     * @param  Currency|null $currencies currencies (optional)
     * @param  PaymentMethod|null $paymentMethods paymentMethods (optional)
     ...
     * @param  DateType|null $spendingDate (optional)
     * @param  string|null $startDate (optional)
     * @param  string|null $endDate (optional)
     * @param  PaymentStatusSpending|null $paymentStatus (optional)
     * @param  Source|null $spendingType (optional)
     * @param  Category|null $categories (optional)
     * @param  Currency|null $currencies (optional)
     * @param  PaymentMethod|null $paymentMethods (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['spendingList'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
