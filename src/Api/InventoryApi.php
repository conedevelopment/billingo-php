...
class InventoryApi
{
    ...
    /**
     * Operation getProductQuantity
     *
     * Retrieve product quantity
     *
     * @param  int $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProductQuantity'] to see the possible values for this operation
     *
     ...
     */
    public function getProductQuantity($id, string $contentType = self::contentTypes['getProductQuantity'][0])
    {
        list($response) = $this->getProductQuantityWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation getProductQuantityWithHttpInfo
     *
     * Retrieve product quantity
     *
     ...
     */
    public function getProductQuantityWithHttpInfo($id, string $contentType = self::contentTypes['getProductQuantity'][0])
    {
        $request = $this->getProductQuantityRequest($id, $contentType);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\Cone\Billingo\Model\ProductQuantity' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cone\Billingo\Model\ProductQuantity' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Cone\Billingo\Model\ProductQuantity', []),
            ...
            $returnType = '\Cone\Billingo\Model\ProductQuantity';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cone\Billingo\Model\ProductQuantity',
    ...
    /**
     * Operation getProductQuantityAsync
     *
     * Retrieve product quantity
     *
     * @param  int $id (required)
     ...
     */
    public function getProductQuantityAsync($id, string $contentType = self::contentTypes['getProductQuantity'][0])
    {
        return $this->getProductQuantityAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getProductQuantityAsyncWithHttpInfo
     *
     * Retrieve product quantity
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getProductQuantityAsyncWithHttpInfo($id, string $contentType = self::contentTypes['getProductQuantity'][0])
    {
        $returnType = '\Cone\Billingo\Model\ProductQuantity';
        $request = $this->getProductQuantityRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'getProductQuantity'
     *
     * @param  int $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getProductQuantity'] to see the possible values for this operation
     *
     ...
     */
    public function getProductQuantityRequest($id, string $contentType = self::contentTypes['getProductQuantity'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling getProductQuantity'
            );
        }


        $resourcePath = '/inventory/product/{id}/quantity';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
