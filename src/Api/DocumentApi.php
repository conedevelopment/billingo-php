...
class DocumentApi
{
     ...
     * @param  PaymentMethod|null $paymentMethod Filter documents by PaymentMethod value. (optional)
     * @param  PaymentStatus|null $paymentStatus Filter documents by PaymentStatus value. (optional)
