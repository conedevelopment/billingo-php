...
class DocumentApi
{
    ...
    public function cancelDocumentWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\Document', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
    ...
    public function deletePaymentWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\PaymentHistory[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function downloadDocumentWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                ...
                case 202:
                    if (in_array('\Cone\Billingo\Model\ClientError', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function getOnlineSzamlaStatusWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\OnlineSzamlaStatus', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function getPublicUrlWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\DocumentPublicUrl', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function listDocumentWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\DocumentList', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
    ...
    public function sendDocumentWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\SendDocument', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
