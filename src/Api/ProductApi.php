...
class ProductApi
{
     ...
     * @return \Cone\Billingo\Model\Product|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse
     */
    public function createProduct(
        \Cone\Billingo\Model\Product $product,
        string $contentType = self::contentTypes['createProduct'][0]
    ): \Cone\Billingo\Model\Product|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse {
    ...
    public function createProductWithHttpInfo(
        ...
        try {
            ...
            switch ($statusCode) {
                case 201:
                    if (in_array('\Cone\Billingo\Model\Product', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \Cone\Billingo\Model\ProductList|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse
     */
    public function listProduct(
        ?int $page = null,
        ?int $perPage = 25,
        ?string $query = null,
        string $contentType = self::contentTypes['listProduct'][0]
    ): \Cone\Billingo\Model\ProductList|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse {
     ...
     */
    public function listProductWithHttpInfo(
        ?int $page = null,
        ?int $perPage = 25,
        ?string $query = null,
        string $contentType = self::contentTypes['listProduct'][0]
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if (in_array('\Cone\Billingo\Model\ProductList', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'], true)) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return PromiseInterface
     */
    public function listProductAsync(
        ?int $page = null,
        ?int $perPage = 25,
        ?string $query = null,
        string $contentType = self::contentTypes['listProduct'][0]
     ...
     * @return PromiseInterface
     */
    public function listProductAsyncWithHttpInfo(
        ?int $page = null,
        ?int $perPage = 25,
        ?string $query = null,
        string $contentType = self::contentTypes['listProduct'][0]
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listProductRequest(
        ?int $page = null,
        ?int $perPage = 25,
        ?string $query = null,
        string $contentType = self::contentTypes['listProduct'][0]
