...
class ProductApi
{
     ...
     */
    public function listProduct($page = null, $perPage = 25, $query = null, string $contentType = self::contentTypes['listProduct'][0])
    {
        list($response) = $this->listProductWithHttpInfo($page, $perPage, $query, $contentType);
        return $response;
    }
     ...
     */
    public function listProductWithHttpInfo($page = null, $perPage = 25, $query = null, string $contentType = self::contentTypes['listProduct'][0])
    {
        $request = $this->listProductRequest($page, $perPage, $query, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProductAsync($page = null, $perPage = 25, $query = null, string $contentType = self::contentTypes['listProduct'][0])
    {
        return $this->listProductAsyncWithHttpInfo($page, $perPage, $query, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listProductAsyncWithHttpInfo($page = null, $perPage = 25, $query = null, string $contentType = self::contentTypes['listProduct'][0])
    {
        $returnType = '\Cone\Billingo\Model\ProductList';
        $request = $this->listProductRequest($page, $perPage, $query, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listProductRequest($page = null, $perPage = 25, $query = null, string $contentType = self::contentTypes['listProduct'][0])
    {


        if ($perPage !== null && $perPage > 100) {
            throw new \InvalidArgumentException('invalid value for "$perPage" when calling ProductApi.listProduct, must be smaller than or equal to 100.');
        }
