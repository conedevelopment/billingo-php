...
class BankAccountApi
{
     ...
     */
    public function createBankAccount($bankAccount, string $contentType = self::contentTypes['createBankAccount'][0])
    {
     ...
     */
    public function createBankAccountWithHttpInfo($bankAccount, string $contentType = self::contentTypes['createBankAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Cone\Billingo\Model\BankAccount' === '\SplFileObject') {
     ...
     */
    public function createBankAccountAsync($bankAccount, string $contentType = self::contentTypes['createBankAccount'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createBankAccountAsyncWithHttpInfo($bankAccount, string $contentType = self::contentTypes['createBankAccount'][0])
    {
        $returnType = '\Cone\Billingo\Model\BankAccount';
        $request = $this->createBankAccountRequest($bankAccount, $contentType);
     ...
     */
    public function createBankAccountRequest($bankAccount, string $contentType = self::contentTypes['createBankAccount'][0])
    {
     ...
     * @throws \Cone\Billingo\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Cone\Billingo\Model\BankAccountList|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse
     */
    public function listBankAccount($page = null, $perPage = 25, string $contentType = self::contentTypes['listBankAccount'][0])
    {
     ...
     */
    public function listBankAccountWithHttpInfo($page = null, $perPage = 25, string $contentType = self::contentTypes['listBankAccount'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cone\Billingo\Model\BankAccountList' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBankAccountAsync($page = null, $perPage = 25, string $contentType = self::contentTypes['listBankAccount'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listBankAccountAsyncWithHttpInfo($page = null, $perPage = 25, string $contentType = self::contentTypes['listBankAccount'][0])
    {
        $returnType = '\Cone\Billingo\Model\BankAccountList';
        $request = $this->listBankAccountRequest($page, $perPage, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function listBankAccountRequest($page = null, $perPage = 25, string $contentType = self::contentTypes['listBankAccount'][0])
    {
     ...
     * @return \Cone\Billingo\Model\BankAccount|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse|\Cone\Billingo\Model\ClientErrorResponse
     */
    public function updateBankAccount($id, $bankAccount, string $contentType = self::contentTypes['updateBankAccount'][0])
    {
     ...
     * @return array of \Cone\Billingo\Model\BankAccount|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\SubscriptionErrorResponse|\Cone\Billingo\Model\ClientErrorResponse|\Cone\Billingo\Model\ValidationErrorResponse|\Cone\Billingo\Model\TooManyRequestsResponse|\Cone\Billingo\Model\ServerErrorResponse|\Cone\Billingo\Model\ClientErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateBankAccountWithHttpInfo($id, $bankAccount, string $contentType = self::contentTypes['updateBankAccount'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBankAccountAsync($id, $bankAccount, string $contentType = self::contentTypes['updateBankAccount'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateBankAccountAsyncWithHttpInfo($id, $bankAccount, string $contentType = self::contentTypes['updateBankAccount'][0])
    {
        $returnType = '\Cone\Billingo\Model\BankAccount';
        $request = $this->updateBankAccountRequest($id, $bankAccount, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateBankAccountRequest($id, $bankAccount, string $contentType = self::contentTypes['updateBankAccount'][0])
    {
