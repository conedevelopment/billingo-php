...
class OnlineSzamlaStatusEnum
{
    ...
    public const DONT_SEND_EXTERNAL_IMPORT = 'dont_send_external_import';
    ...
    public const INVALID_REQUEST_SIGNATURE = 'invalid_request_signature';
    ...
    public static function getAllowableEnumValues()
    {
        return [
            self::ABORTED,
            self::DONE,
            self::DONT_SEND_EXTERNAL_IMPORT,
