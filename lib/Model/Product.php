...
class Product implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_manage', $data ?? [], null);
    ...
    */
     ...
     *
     * @param float|null $gross_unit_price gross_unit_price
     *
     * @return self
     */
    public function setGrossUnitPrice($gross_unit_price)
    {
        if (is_null($gross_unit_price)) {
            throw new \InvalidArgumentException('non-nullable gross_unit_price cannot be null');
        }
    ...
    {
        return $this->container['is_manage'];
    }

    /**
     * Sets is_manage
     *
     * @param bool|null $is_manage is_manage
     *
     * @return self
     */
    public function setIsManage($is_manage)
    {
        if (is_null($is_manage)) {
            throw new \InvalidArgumentException('non-nullable is_manage cannot be null');
        }
        $this->container['is_manage'] = $is_manage;
