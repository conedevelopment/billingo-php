...
class DocumentSummary implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'vat_rate_summary' => '\Cone\Billingo\Model\DocumentVatRateSummary[]'
    ];
    ...
    protected static array $openAPINullables = [
        'net_amount' => false,
		'net_amount_local' => false,
		'gross_amount_local' => false,
		'vat_amount' => false,
		'vat_amount_local' => false,
		'vat_rate_summary' => false
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('net_amount_local', $data ?? [], null);
        $this->setIfExists('gross_amount_local', $data ?? [], null);
        $this->setIfExists('vat_amount', $data ?? [], null);
        $this->setIfExists('vat_amount_local', $data ?? [], null);
        $this->setIfExists('vat_rate_summary', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param float|null $net_amount_local net_amount_local
     *
     * @return self
     */
    public function setNetAmountLocal($net_amount_local)
    {
        if (is_null($net_amount_local)) {
            throw new \InvalidArgumentException('non-nullable net_amount_local cannot be null');
        }
     ...
     *
     * @param float|null $gross_amount_local gross_amount_local
     *
     * @return self
     */
    public function setGrossAmountLocal($gross_amount_local)
    {
        if (is_null($gross_amount_local)) {
            throw new \InvalidArgumentException('non-nullable gross_amount_local cannot be null');
        }
     ...
     *
     * @param float|null $vat_amount_local vat_amount_local
     *
     * @return self
     */
    public function setVatAmountLocal($vat_amount_local)
    {
        if (is_null($vat_amount_local)) {
            throw new \InvalidArgumentException('non-nullable vat_amount_local cannot be null');
        }
     ...
     *
     * @param \Cone\Billingo\Model\DocumentVatRateSummary[]|null $vat_rate_summary vat_rate_summary
     *
     * @return self
     */
    public function setVatRateSummary($vat_rate_summary)
    {
        if (is_null($vat_rate_summary)) {
            throw new \InvalidArgumentException('non-nullable vat_rate_summary cannot be null');
        }
