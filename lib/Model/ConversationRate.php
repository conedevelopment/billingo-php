...
class ConversationRate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('conversation_rate', $data ?? [], null);
    ...
    */
     ...
     * Sets from_currency
     *
     * @param \Cone\Billingo\Model\Currency|null $from_currency from_currency
     *
     * @return self
     */
     ...
     * Sets to_currency
     *
     * @param \Cone\Billingo\Model\Currency|null $to_currency to_currency
     *
     * @return self
     */
    ...
    {
        if (is_null($conversation_rate)) {
            throw new \InvalidArgumentException('non-nullable conversation_rate cannot be null');
        }
