...
class SpendingListItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_created_by_nav', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param bool|null $is_created_by_nav is_created_by_nav
     *
     * @return self
     */
    public function setIsCreatedByNav($is_created_by_nav)
    {
        if (is_null($is_created_by_nav)) {
            throw new \InvalidArgumentException('non-nullable is_created_by_nav cannot be null');
        }
