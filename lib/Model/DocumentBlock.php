...
class DocumentBlock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentBlock';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('custom_field2', $data ?? [], null);
    ...
    */
     ...
     * Sets custom_field1
     *
     * @param string|null $custom_field1 custom_field1
     *
     * @return self
     */
     ...
     * Sets custom_field2
     *
     * @param string|null $custom_field2 custom_field2
     *
     * @return self
     */
    public function setCustomField2($custom_field2)
    {
        if (is_null($custom_field2)) {
            throw new \InvalidArgumentException('non-nullable custom_field2 cannot be null');
        }
