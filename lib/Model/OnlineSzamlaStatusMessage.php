...
class OnlineSzamlaStatusMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static array $openAPINullables = [
		...
		'validation_error_code' => false,
		'human_readable_message' => false
    ];
    ...
    {
        $this->setIfExists('validation_result_code', $data ?? [], null);
        $this->setIfExists('validation_error_code', $data ?? [], null);
        $this->setIfExists('human_readable_message', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param string|null $validation_result_code validation_result_code
     *
     * @return self
     */
    public function setValidationResultCode($validation_result_code)
    {
        if (is_null($validation_result_code)) {
            throw new \InvalidArgumentException('non-nullable validation_result_code cannot be null');
        }
     ...
     *
     * @param string|null $validation_error_code validation_error_code
     *
     * @return self
     */
    public function setValidationErrorCode($validation_error_code)
    {
        if (is_null($validation_error_code)) {
            throw new \InvalidArgumentException('non-nullable validation_error_code cannot be null');
        }
     ...
     *
     * @param string|null $human_readable_message human_readable_message
     *
     * @return self
     */
    public function setHumanReadableMessage($human_readable_message)
    {
        if (is_null($human_readable_message)) {
            throw new \InvalidArgumentException('non-nullable human_readable_message cannot be null');
        }
