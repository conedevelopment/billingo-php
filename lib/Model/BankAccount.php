...
class BankAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('account_number_iban', $data ?? [], null);
        $this->setIfExists('swift', $data ?? [], null);
        $this->setIfExists('currency', $data ?? [], null);
        $this->setIfExists('need_qr', $data ?? [], false);
    }
    ...
    */
    ...
    {
        if (is_null($account_number_iban)) {
            throw new \InvalidArgumentException('non-nullable account_number_iban cannot be null');
        }
    ...
    {
        if (is_null($need_qr)) {
            throw new \InvalidArgumentException('non-nullable need_qr cannot be null');
        }
