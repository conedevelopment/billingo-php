...
/**
     ...
     * @param  DateType $spending_date spending_date (optional)
     * @param  string $start_date start_date (optional)
     * @param  string $end_date end_date (optional)
     * @param  PaymentStatusSpending $payment_status payment_status (optional)
     * @param  Source $spending_type spending_type (optional)
     * @param  Category $categories categories (optional)
     * @param  Currency $currencies currencies (optional)
     * @param  PaymentMethod $payment_methods payment_methods (optional)
     ...
     * @param  DateType $spending_date (optional)
     * @param  string $start_date (optional)
     * @param  string $end_date (optional)
     * @param  PaymentStatusSpending $payment_status (optional)
     * @param  Source $spending_type (optional)
     * @param  Category $categories (optional)
     * @param  Currency $currencies (optional)
     * @param  PaymentMethod $payment_methods (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['spendingList'] to see the possible values for this operation
     *
     * @throws \Cone\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Cone\Billingo\Model\SpendingSave $spending_save spending_save (optional)
     ...
     * Creates a new spending.
     *
     * @param  \Cone\Billingo\Model\SpendingSave $spending_save (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['spendingSave'] to see the possible values for this operation
     *
     * @throws \Cone\Billingo\ApiException on non-2xx response
     * @throws \InvalidArgumentException
