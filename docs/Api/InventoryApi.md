...
```php
getProductQuantity($id): \Cone\Billingo\Model\ProductQuantity
```
...
$apiInstance = new Cone\Billingo\Api\InventoryApi(
...
[**\Cone\Billingo\Model\ProductQuantity**](../Model/ProductQuantity.md)
