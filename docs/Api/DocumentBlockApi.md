...
$page = 56; // int
$perPage = 25; // int
$type = invoice; // \Cone\Billingo\Model\DocumentBlockType | Filter document blocks by type
...
| **type** | [**\Cone\Billingo\Model\DocumentBlockType**](../Model/.md)| Filter document blocks by type | [optional] |
